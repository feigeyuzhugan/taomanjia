package com.zhongzi.taomanjia.view.widget.autoscrollviewpager;
...
import com.zhongzi.taomanjia.view.widget.autoscrollviewpager.transformer.BGAPageTransformer;
import com.zhongzi.taomanjia.view.widget.autoscrollviewpager.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private int mPointDrawableResId = R.drawable.selector_bga_banner_point_solid;
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.BGABanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.selector_bga_banner_point_solid);
    ...
    public void setData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.lib_bga_banner_item_image, models, tips);
    }
