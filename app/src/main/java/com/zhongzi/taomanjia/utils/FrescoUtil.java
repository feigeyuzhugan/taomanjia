...
import com.zhongzi.taomanjia.app.MyApplication;
...
public class FrescoUtil {
    ...
    private static final int DEFAULT_IMG_LOADING = R.mipmap.ic_launcher;//默认加载中图片
    private static final int DEFAULT_IMG_FAILURE = R.mipmap.ic_launcher;//默认加载失败图片
    private static final int DEFAULT_IMG_RETRY = R.mipmap.ic_launcher;//默认重新加载的图片
